...
(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
(3, 'user03', 'pass03', '강감찬', '남', '010-777-7777', 'gang123@gmail.com');
...
CREATE TABLE IF NOT EXISTS user_foreignkey2 (
    ...
    FOREIGN KEY (grade_code) 
        ...
        ON UPDATE SET NULL
        ON DELETE SET NULL   
-- update나 delete를 했을 때 null값이 들어가게 함
-- 부모 테이블이 아예 삭제가 되어도 문제가 되지 않음
DROP TABLE IF EXISTS user_foreignkey2;
CREATE TABLE IF NOT EXISTS user_foreignkey2 (
    user_no INT PRIMARY KEY,
    user_id VARCHAR(255) NOT NULL,
...
-- 남 또는 여 중 하나라도 되면 gender에 들어갈 수 있음
...
-- 성별에 잘못된 값 입력해보기 -- 에러 발생
INSERT
  INTO user_check
VALUES 
(NULL, '아메바', '중', 19);

-- 나이에 잘못된 값 입력해보기 -- 에러 발생
INSERT
  INTO user_check
VALUES
(NULL, '유관순', '여', 17);
